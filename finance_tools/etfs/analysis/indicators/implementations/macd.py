# finance_tools/etfs/analysis/indicators/implementations/macd.py
...
class MACDIndicator(BaseIndicator):
    ...
    def get_score(self, df: pd.DataFrame, column: str, config: IndicatorConfig) -> Optional[IndicatorScore]:
        ...
        params = config.parameters
        fast = int(params.get('window_fast', 12))
        slow = int(params.get('window_slow', 26))
        signal = int(params.get('window_sign', 9))
