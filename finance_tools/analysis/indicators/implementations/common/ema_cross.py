# finance_tools/analysis/indicators/implementations/common/ema_cross.py
"""
EMA Crossover indicator - Universal for both stocks and ETFs.

This indicator is already implemented in both stock and ETF modules.
This unified version works with both 'close' (stocks) and 'price' (ETFs).
"""
...
class EMACrossIndicator(BaseIndicator):
    """EMA Crossover indicator - works for both stocks and ETFs"""
    ...
    def get_asset_types(self) -> List[str]:
        """EMA Cross works for both asset types"""
        return ['stock', 'etf']
